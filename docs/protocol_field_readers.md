...
Source: `configs/protocol_v1.2.yaml`. A reader is a string literal in
...
| --- | --- | --- |
| `protocol_version` | 1.2.0 | `drososense/evaluation/results.py:366`, `drososense/evaluation/results.py:46`, `drososense/evaluation/results.py:559` |
| `frozen` | True | `drososense/utils/config.py:21`, `drososense/utils/protocol.py:102`, `drososense/utils/protocol.py:102` |
| `frozen_at` | 2026-09-20T08:40:21Z | `drososense/utils/protocol.py:103`, `drososense/utils/protocol.py:103`, `drososense/utils/protocol.py:161` |
| `supersedes` | 1.1.0 | `drososense/utils/protocol.py:freeze_status (reported, not decided)` |
...
| `freeze_evidence.previous_version.protocol_version` | 1.1.0 | `drososense/evaluation/results.py:366`, `drososense/evaluation/results.py:46`, `drososense/evaluation/results.py:559` |
| `freeze_evidence.previous_version.frozen_at` | 2026-09-20T06:04:51Z | `drososense/utils/protocol.py:103`, `drososense/utils/protocol.py:103`, `drososense/utils/protocol.py:161` |
...
| `split_protocol.per_dataset.D3.strategy` | group_kfold | `drososense/data/pipeline.py:82`, `drososense/evaluation/runner.py:156`, `scripts/preprocess.py:108` |
| `split_protocol.per_dataset.D3.n_splits` | 5 | `drososense/evaluation/runner.py:129`, `drososense/evaluation/runner.py:156` |
